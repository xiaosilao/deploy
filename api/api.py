...
def Date_time():
    ...
    week_start_dt = now_time - datetime.timedelta(days=now_time.weekday())
    week_start_time = datetime.datetime.strptime(week_start_dt.strftime('%Y-%m-%d'), '%Y-%m-%d')
    month_start_time = datetime.datetime.strptime(month_start_dt.strftime('%Y-%m-%d'), '%Y-%m-%d')
    ...
    return start_time, stop_time, week_start_time, month_start_time
